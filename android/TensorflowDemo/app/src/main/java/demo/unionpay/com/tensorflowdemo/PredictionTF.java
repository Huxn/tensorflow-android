...
public class PredictionTF {
    ...
    private static final int OUT_ROW = 10;
    //模型中输入变量的名称
    private static final String inputName = "input/x_input";
    //模型中输出变量的名称
    private static final String outputName = "output";
    private HashMap<Integer, Float> result = new HashMap<>();
     ...
     * @return 返回预测结果，int数组
     */
    public HashMap<Integer, Float> getPredict(Bitmap bitmap) {
